...
namespace MediaCurator
{
    class MediaFile : MediaContainer
    {
        ...
        public MediaFile(string type, string path)
        ...
        public MediaFile(XElement element, bool update = false)
           : base(element, update)
        {
                    ...
                    Task.Run(async delegate
                   {
                       while (true)
                       {
                           ...
                           try
                           {
                               ...
                               if (ThumbnailsDatabase.Instance.DeleteThumbnails(Id) > 0)
                               {
    ...
    #region Photo / Video Common Functionality
