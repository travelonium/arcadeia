    ...
    public class MediaContainerFlags : INotifyPropertyChanged
    {
        ...
        public ImageSource Source
        {
            get
            {
                if (Deleted)
                {
                    var source = new BitmapImage(new Uri("pack://application:,,,/Icons/24x24/Deleted.png"));
                ...
                {
                    var source = new BitmapImage(new Uri("pack://application:,,,/Icons/24x24/Favourite.png"));
